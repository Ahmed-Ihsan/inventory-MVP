              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1rem', color: '#1e293b', fontWeight: 600 }}>
                      {new Date(sale.start_date).toLocaleDateString('ar-SA')}
                    </div>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1.125rem', color: '#10b981', fontWeight: 700 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1.125rem', color: '#f59e0b', fontWeight: 700 }}>
                      {formatCurrency(correctDownPayment)}
                    </div>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '1.125rem', color: '#3b82f6', fontWeight: 700 }}>
                      {formatCurrency(correctRemaining)}
                    </div>
                  </div>
                </div>
              </div>
